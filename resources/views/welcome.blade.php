...
@section('content')
    <div class="w-full mt-16 flex flex-col justify-center items-center">
        <div class="grid grid-cols-[1fr_0.8fr] space-y-4 max-w-[1350px] items-center"
        ...
        'button img';">
            ...
            <div style="grid-area: desc" class="pt-[20px] pr-24 text-[110%]">
                <p>Dari menghubungkan petani lokal dengan pengepul terbaik hingga
                    ...
                    Anda mendapatkan manfaat maksimal dari kopi Anda.
                </p>
            </div>
            <div style="grid-area: button">
                <a href="{{ route('login') }}">
                    <button class="bg-[#1C3F3A] text-[#EBE8D8] font-semibold text-[130%] px-20 py-5 rounded-[35px]">Mulai
                        sekarang</button></a>
            </div>
            ...
            <div>
                <div class="grid grid-cols-2 space-x-6 pt-5">
                    <div class="bg-white p-10 rounded-[10px] h-[500px] text-black">
                        ...
                        <p class="text-[130%] pt-8"> <span class="font-semibold">Harga tertinggi</span> <br> Terima
                            penawaran dari berbagai pengepul dan pilih yang terbaik.</p>
                        <p class="text-[130%] pt-8"> <span class="font-semibold">Cakupan luas</span> <br>Jangkau pengepul
                            dari berbagai wilayah, tanpa perantara.</p>
                        <a href="{{ route('register') }}">
                            <button
                                class="bg-[#54473F] text-[130%] text-white font-semibold px-10 py-4 mt-10 ml-64 rounded-[30px]">Jual
                                kopi sekarang >
                            </button>
                        </a>
                    </div>
                    <div class="bg-[#54473F] p-10 rounded-[10px] rounded-tr-[125px] text-white">
                        ...
                        <p class="text-[130%] pt-8"> <span class="font-semibold">Akses langsung</span> <br>Terhubung dengan
                            petani dari daerah penghasil kopi terbaik di Indonesia.</p>
                        <p class="text-[130%] pt-8"> <span class="font-semibold">Efisiensi waktu</span> <br>Hemat waktu
                            dengan proses negosiasi yang cepat dan transparan.</p>
                        <a href="{{ route('register') }}">
                            <button
                                class="bg-white text-[130%] text-[#54473F] font-semibold px-10 py-4 mt-10 ml-64 rounded-[30px]">Cari
                                kopi sekarang >
                            </button>
                        </a>
                    </div>
                ...
                <div>
                    <div>
                        <div class="mb-8">
                            <div class="accordion grid grid-cols-[1fr_0.1fr] space-x-6 items-center mb-4">
                                <p class="font-semibold text-[130%]" id="teks1">Bagaimana cara petani mendaftarkan <br>
                                    kopi mereka?</p>
                                <i data-feather="plus" class=" items-center cursor-pointer" id="plus1"
                                    onclick="showDesc1()"></i>
                            </div>
                            <div>
                                <p class="text-[130%] pr-24 hidden" id="desc1">Petani dapat mengunggah detail kopi
                                    mereka melalui dashboard kami.</p>
                            </div>
                        </div>
                    ...
                    <div>
                        <div class="my-8">
                            <div class="grid grid-cols-[1fr_0.1fr] space-x-6 items-center mb-4">
                                <p class="font-semibold text-[130%]" id="teks2">Bagaimana pengepul memberikan <br>
                                    penawaran harga?</p>
                                <i data-feather="plus" class="items-center cursor-pointer" id="plus2"></i>
                            </div>
                            <div>
                                <p class="text-[130%] pr-24 hidden" id="desc2">Pengepul dapat melihat produk dan
                                    memberikan penawaran melalui sistem bidding.</p>
                            </div>
                        </div>
                        <hr class="border-[#c6c6c661] border-[2px] w-full">
                    </div>
                    <div>
                        <div class="my-8">
                            ...
                            <div>
                                <p class="text-[130%] pr-24 hidden" id="desc3">Ya, kami menggunakan sistem escrow untuk
                                    memastikan keamanan kedua belah pihak.</p>
                            </div>
                        </div>
                        <hr class="border-[#c6c6c661] border-[2px] w-full">
                    </div>
        ...
        <div class="grid grid-cols-[0.7fr_1fr] w-[1350px] h-[360px] bg-[#1C3F3A] overflow-hidden rounded-[10px] mb-24">
            ...
            <div class="px-14 py-4">
                ...
                <a href="{{ route('login') }}">
                    <button
                        class="bg-white text-[130%] text-[#1C3F3A] font-semibold px-10 py-4 mt-5 ml-96 rounded-[30px]">Mulai
                        sekarang ></button>
                </a>
            </div>
        </div>
